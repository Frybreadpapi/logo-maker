...
function promptUser() {
    inquirer.prompt([
        {
            type:"input",
            message: "enter three characters you would like to see on your shape.",
            name: "text",

        },
        {
            type:"input",
            message: "choose a color keyword or a hexadecimal number for the text color.",
            name: "textColor",
        ...
        {
            type:"input",
            message: "choose a color keyword or a hexadecimal number for the shape color.",
            name: "shapeColor",
